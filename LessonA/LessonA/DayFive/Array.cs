...
namespace LessonA.DayFive
{
    internal class ArrayClass
    {
        ...
        public static void FirsMethod()
        {
            ...
            Console.WriteLine("Avg:" + sample.Average());
            Console.WriteLine("Maximum:" + sample.Max());
            Console.WriteLine("Minimum:" + sample.Min());
        }
        ...
        {   // first loop through rows and second through columns
            int t, i;
        ...
        //array have unequal columns. technically single array but have multiple inside them
        ...
        // take a value type and put it inside an object is called boxing. false is boxing
