...
namespace LessonA.DayEight
{
    internal class BinaryStreamDemo
    {
        ...
        public static void WriteBytesToMemoryStream()
        {
            ...
            //bool flag = true;  //boolean need to be stored so they are converted into bit that can be done by bitconverter
            //byte[] data = BitConverter.GetBytes(flag);
            BinaryWriter binWriter = new BinaryWriter(memoryStream); //binaryriter is a erapper to memrystream
        ...
        public static void WriteStringToMemoryStream()
        {
            ...
            //String is taken and need to convert into byte array. encoding.Ascci.getbytes is used to convert them
        ...
        public static void ReadStringFromMemoryStream()
        {
            ...
            //There is a array of bytes and need to convert into string then encoding.ascii.getString
